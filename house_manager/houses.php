                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title-box">
                                        <h3><i class="fa fa-list"></i>&nbsp;List of all houses</h3>
                                    </div>
                                    <ul class="panel-controls" style="margin-top: 2px;">
                                      ...
                                      <a href = "register_house.php"><i class="fa fa-plus-circle"></i>&nbsp;Add new house</a>										
                                    </ul>
                                </div>
                                <div class="panel-body">
								   ...
								   <thead>
								   <th width="350px">S#</th>
                                    <th width="350px">House ID</th>
									<th width="350px">Location</th>
									<th width="350px">Action</th>
                                   </thead>									
									<tbody>
									<?php
                                    $add = mysql_query("select * from hms_houses");
                                    $a = 1;
                                    while($r=mysql_fetch_array($add)){
									?>
									<tr>
									<td><?php echo $a;?></td>
									<td><?php echo $r['house_id'] ;?></td>
									<td><?php echo $r['location'] ;?></td>
									<td><a href="list_of_rooms.php?id=<?php echo $r['house_id'] ;?>"><i class="fa fa-eye"></i>&nbsp;view rooms</a> | <a href=""><i class="fa fa-edit"></i>&nbsp;edit</a> | <a href="delete_house.php?id=<?php echo $r['id'] ;?>" onclick="return confirm('Are you sure you want to delete this house?')" style="color: #b64645"><i class="fa fa-trash-o"></i>&nbsp;delete</a></td>
									</tr>
									<?php
									$a++;
								    }
