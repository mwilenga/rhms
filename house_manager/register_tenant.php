...
<head>        
        <!-- META SECTION -->
        <title>rhms - Register tenant</title>            
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title-box">
                                       <h3><i class="fa fa-list"></i>&nbsp;Tenant details</h3>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="row">
                                      ...
                                      <button type="submit" style="float:right; margin-right:4px" class="btn btn-danger">Cancel</button>
                                     </div>
                                    </div>
                                    <div class="col-md-6">
